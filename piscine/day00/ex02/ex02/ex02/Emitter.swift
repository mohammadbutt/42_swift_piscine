...
//        emitter.emitterCells = generateEmitterCellsImage2(with: image2)
        return emitter
    }
...
/*
    static func generateEmitterCellsImage2(with image2: UIImage) -> [CAEmitterCell]
    {
        var cells = [CAEmitterCell]()
        let cell = CAEmitterCell()
        cell.contents = image2.cgImage
        cell.birthRate = 5
        cell.lifetime = 8
        //        cell.velocity = CGFloat(100)
        cell.velocity = 100
